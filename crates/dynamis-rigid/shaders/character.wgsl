...
fn character_query(character: Character, origin: vec3f, direction: vec3f, extent: f32) -> Query {
    ...
    query.filter_flags = FILTER_IGNORE_SENSORS;
    query.slot = 0u;
    query.group = 0u;
    query.mask = 0xFFFFFFFFu;
    query.source = 0u;
    query.max_hits = 1u;
    query.exclude_id = character.body_id;
    query.exclude_generation = character.generation;
    query.include_id = NO_BODY;
    query.include_generation = 0u;
    query.origin = origin;
