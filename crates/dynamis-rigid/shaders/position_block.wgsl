...
@group(0) @binding(4) var<storage, read_write> position_deltas: array<atomic<u32>>;
@group(0) @binding(5) var<storage, read> resolution: array<vec4f>;
...
@group(0) @binding(8) var<storage, read> blocks: array<u32>;
