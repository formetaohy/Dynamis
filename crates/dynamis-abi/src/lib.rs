...
pub use counter::device::{
    ...
    COUNTER_GRID_SCALE, COUNTER_JOINTS, COUNTER_LIVE, COUNTER_LIVE_FAULTS, COUNTER_PAIRS,
    COUNTER_PARTICLE_REACH, COUNTER_REFUSED_EVENTS, COUNTER_REFUSED_PAIRS, COUNTER_REFUSED_RESTING,
