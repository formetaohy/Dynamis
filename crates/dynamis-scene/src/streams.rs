...
streams! {
    ...
    streams {
        query_records, QueryRecords: "queries", QueryRecord, 1, Retention::Scratch, StreamWriters::HostThenDevice, demand.queries;
        query_hits, QueryHits: "query hits", QueryHitRecord, 1, Retention::Scratch, StreamWriters::Device, demand.hits;
    }
}
