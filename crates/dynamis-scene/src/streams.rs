...
streams! {
    ...
    streams {
        query_records, QueryRecords: "queries", QueryRecord, 1, Retention::Scratch, StreamFill::Host, demand.queries;
        query_hits, QueryHits: "query hits", QueryHitRecord, 1, Retention::Scratch, StreamFill::Device, demand.hits;
    }
}
