...
streams! {
    ...
    streams {
        ...
        pair_major, PairMajor: "pairs major", u32, 1, Retention::Scratch, demand.pairs;
        pair_minor, PairMinor: "pairs minor", u32, 1, Retention::Scratch, demand.pairs;
        sort_dummy, SortDummy: "sort key dummy", u32, 1, Retention::Scratch, demand.sort;
