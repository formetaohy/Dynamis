...
use dynamis_layout::{
    ...
    COUNTER_WOKE, DOF_FREE, DOF_LIMITED, DOF_LOCKED, EVENT_BEGIN, EVENT_END, EVENT_PERSIST,
    FILTER_IGNORE_KINEMATIC, FILTER_IGNORE_SENSORS, FILTER_IGNORE_SLEEPING, FILTER_IGNORE_STATIC,
    ISLAND_ACTIVE, ISLAND_WAKE, MAX_HITS_PER_QUERY, NO_BODY, NO_COLLISION_FILTER, NO_HIT, NO_SLOT,
