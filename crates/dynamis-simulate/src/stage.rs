...
use dynamis_layout::{
    ...
    PATCH_GROUP, PATCH_INVERSE_MASS, PATCH_KINEMATIC, PATCH_MASK, PATCH_ORIENTATION,
    ...
    SHAPE_MESH, SHAPE_NONE, SHAPE_SOURCE_HEIGHTFIELD, SHAPE_SOURCE_HULL, SHAPE_SOURCE_MESH,
    SHAPE_SPHERE,
};
